...
![](img/claimviz_tldo.jpg){#fig-claimviz-tldo}

Claim about visualisations (p16 of response)
:::

::: {#fig-claim-vizb layout-ncol=2}

![Original Version of Figure 7](img/fig7_original.jpg){#fig-claimviz-tldo}

![Corrected Version of Figure 7](img/fig7_corrected.jpg){#fig-claimviz-dekadt}
